							...
							<div class="card-body">
								...
								<div class="col-sm-6">		
								  	<div class="form-group">
								  		...
								  		<input type="password" name="password" id="password" required="required" placeholder="Password" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
								  		<label for="password2">Konfirmasi Password</label>
								  		<input type="password" name="password2" id="password2" required="required" placeholder="Konfirmasi Password" autocomplete="off" class="form-control">
								  	</div>
								</div>
								</div>
								  	<div class="form-group">
								  		<label for="foto">Foto</label>
								  		<input type="file" name="foto" id="foto" required="required" placeholder="Foto" autocomplete="off" class="form-control-file">
								  		<p class="text-danger">ukuran foto wajib 200px</p>
								  	</div>
								  	<div class="form-group">
	                 				...
	                 				<tbody>
										<?php while($akun = $data_akun->fetch_object()) : ?>
											<tr>
												...
												<td><?= $akun->username ?></td>
												<td>
													<a href="<?= base_url('akun/detail/' . $akun->id) ?>" class="btn btn-sm btn-flat btn-warning"><i class="fa fa-eye"></i> Detail</a>
													<a href="<?= base_url('akun/hapus/' . $akun->id) ?>" class="btn btn-sm btn-flat btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
												</td>
											</tr>
										<?php endwhile; ?>
									</tbody>
