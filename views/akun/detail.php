							...
							<div class="card-body">
								<div class="row">
									...
									<div class="col-md-9">
										<table class="table table-bordered table-md">
											...
											<tr>
												<th class="text-center text-white" style="width:180px;">Nama</th>
												<th class="text-center text-white" style="width:180px;">Username</th>
												<th class="text-center text-white" style="width:180px;">Alamat</th>
												<th class="text-center text-white" style="width:180px;">Level</th>
											</tr>
											</thead>
											<tbody class="bg-secondary">
											<tr>												
												<td class="text-center"><b><?= $akun->nama ?></td>
												<td class="text-center"><b><?= $akun->username ?></b></td>
												<td class="text-center"><b><?= $akun->username ?></b></td>
												<td class="text-center"><b><?= $akun->username ?></b></td>
											</tr>
											</tbody>
								...
								<div class="row">
									<div class="col">
										...
										<a href="<?= base_url('akun') ?>" class="btn btn-sm btn-warning"><i class="fa fa-reply"></i> Kembali</a>
									</div>
								</div>
							</div>
						</div>
